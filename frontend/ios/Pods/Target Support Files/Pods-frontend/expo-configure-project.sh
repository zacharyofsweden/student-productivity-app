...
with_node \
  ...
  --target "/Users/Zhuanz/repos/student-productivity-app/frontend/ios/Pods/Target Support Files/Pods-frontend/ExpoModulesProvider.swift" \
  --entitlement "/Users/Zhuanz/repos/student-productivity-app/frontend/ios/frontend/frontend.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-keep-awake" "expo-notifications"
